...
There are 4 steps:
    ...
    ☂️ Packaging the app for umbrelOS
    🛠 Testing the app on umbrelOS
        Test using an umbrelOS development environment on your local machine
        Test using umbrelOS running on a physical device
    🚀 Submitting the app
